...
const Logo: FC<ILogoProps> = ({ width, height = 32 }) => {
	...
	return (
		<svg
			...
			{/* Database icon */}
			<ellipse cx='20' cy='12' rx='12' ry='5' fill='#4D69FA' />
			<path d='M8 12v8c0 2.76 5.37 5 12 5s12-2.24 12-5v-8' stroke='#4D69FA' strokeWidth='2' fill='none' />
			<path d='M8 20v8c0 2.76 5.37 5 12 5s12-2.24 12-5v-8' stroke='#4D69FA' strokeWidth='2' fill='none' />
			{/* Text */}
