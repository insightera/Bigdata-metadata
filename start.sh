...
print_ui_info() {
  ...
  echo -e "     URL  : ${GREEN}http://localhost:18080${NC}"
  echo ""
  echo -e "  ${YELLOW}🌀 Apache Airflow${NC}"
  echo -e "     URL  : ${GREEN}http://localhost:18681${NC}"
  echo -e "     Login: ${BOLD}airflow / airflow${NC}"
  echo ""
  echo -e "  ${YELLOW}📦 MinIO Console (S3)${NC}"
  echo -e "     URL  : ${GREEN}http://localhost:19001${NC}"
  echo -e "     S3 API (host): ${GREEN}localhost:19000${NC}"
  ...
  echo -e "     Master UI: ${GREEN}http://localhost:19010${NC}"
  echo ""
  echo -e "  ${YELLOW}🔎 Apache Solr${NC} (indeks pencarian Atlas)"
  echo -e "     Admin: ${GREEN}http://localhost:18984/solr/${NC}"
  echo ""
  echo -e "  ${YELLOW}🗂️  Apache Atlas (Data Catalog)${NC}"
  echo -e "     URL  : ${GREEN}http://localhost:22100${NC}"
  ...
  echo -e "     Thrift: ${GREEN}thrift://localhost:19083${NC}"
  echo ""
  echo -e "  ${BLUE}Port host dapat diubah lewat file .env (lihat .env.example).${NC}"
  echo -e "${CYAN}═══════════════════════════════════════════════════${NC}"
  echo ""
